...
- Tầng nghiệp vụ máy chủ: Sử dụng **NestJS 10 trên nền tảng TypeScript** với cấu trúc phân tầng rõ ràng (Module - Controller - Service - DTO - Entity) gồm **39 module nghiệp vụ chuyên biệt** vận hành trên hai bộ máy cốt lõi: Bộ phận phê duyệt dùng chung (Approval Engine / Personnel Actions) và Bộ phận tính lương tự động (Payroll Engine).
- Tầng giao diện người dùng: Ứng dụng web hiện đại **Next.js 14 (App Router)** với **31 trang màn hình ứng dụng thực tế** phân bổ khoa học thành **7 phân hệ nghiệp vụ chính thống** (Tổng quan, Nhân sự, Chấm công, Tiền lương, Phát triển, Báo cáo, Quản trị) cùng 2 giao diện chuyên biệt (Kiosk điểm danh mã QR xoay vòng và điểm danh khuôn mặt, Đăng nhập xác thực JWT), cổng tự phục vụ nhân viên dạng web responsive tối ưu trên cả máy tính lẫn thiết bị di động.
...
| 30                                 | UC30 | Quản lý ca làm việc (phân ca) | CV tiền lương/nhân sự             |
| **Nhóm H - Tiền lương & Phúc lợi mở rộng** *(bổ sung)* | |                       |                                   |
| 31                                 | UC31 | Vận hành bảng lương tự động   | CV tiền lương                     |
| 32                                 | UC32 | Quản lý tạm ứng & khoản vay   | Nhân viên; CV tiền lương duyệt    |
| 33                                 | UC33 | Quản lý công tác phí          | Nhân viên; CV tiền lương duyệt    |
| 34                                 | UC34 | Quản lý tài sản cấp phát      | NV hành chính                     |
| **Nhóm I - Tuyển dụng & Phát triển nâng cao** *(bổ sung)* | |                    |                                   |
| 35                                 | UC35 | Vận hành tuyển dụng ATS Kanban | CV tuyển dụng                    |
| 36                                 | UC36 | Đánh giá hiệu suất KPI & phản hồi 360 độ | CV nhân sự, Trưởng dự án, nhân viên |
| 37                                 | UC37 | Đào tạo & khiếu nại           | CV nhân sự, nhân viên             |
...
| :--- | :--- | :--- | :--- | :--- |
| **1. Tuyển dụng nhân sự & ATS** | Lập phiếu YC tuyển dụng → Thẩm định định biên & quỹ lương → Duyệt mở tuyển → Đăng tin đa kênh → Sàng lọc hồ sơ → Phỏng vấn 2 vòng → Duyệt Offer letter → Tiếp nhận ứng viên. <br>*Chứng từ: Phiếu yêu cầu tuyển dụng, Bản đánh giá phỏng vấn, Thư mời nhận việc.* | **UC04 → UC05 → UC06 → UC07 → UC08**; mở rộng **UC35** (Kanban ATS) | `/recruitment-ats` (Tuyển dụng) <br>`/admin/catalogs` (Danh mục gốc) | Trưởng dự án (Bridge), CV Tuyển dụng (Hub), Kế toán (Hub), Giám đốc (Decision), Ứng viên. |
| **2. Tiếp nhận & Hội nhập (Onboarding)** | Chuyển ứng viên thành nhân viên → Tiếp nhận hồ sơ gốc → Ký HĐLĐ thử việc → Cấp phát tài khoản IT, bàn làm việc → Thực hiện lộ trình hội nhập 14 ngày. <br>*Chứng từ: Hồ sơ cá nhân, Cam kết bảo mật NDA, HĐLĐ thử việc, Onboarding Checklist.* | **UC09, UC10, UC11**; mở rộng **UC44** (Lộ trình hội nhập) | `/employees` (Hồ sơ nhân sự) <br>`/employees/[id]` (Hồ sơ chi tiết) <br>`/documents` (Kho tài liệu) | CV Hồ sơ (Hub), NV Hành chính (Bridge), NV IT (Bridge), Mentor (Bridge), Nhân viên mới. |
| **3. Đánh giá thử việc & Ký HĐ chính thức** | Cảnh báo hết hạn thử việc → PM lập phiếu đánh giá thử việc → Thẩm định khung bậc lương → Duyệt ký HĐLĐ chính thức → Kích hoạt đóng BHXH bắt buộc. <br>*Chứng từ: Phiếu đánh giá thử việc, HĐLĐ chính thức, Quyết định tiếp nhận.* | **UC10, UC13** | `/employees/[id]` (Hồ sơ chi tiết) <br>`/personnel` (Biến động nhân sự) <br>`/salary-ranks` (Ngạch bậc lương) | Trưởng dự án (Bridge), CV Nhân sự (Hub), CV Tiền lương (Hub), Giám đốc (Decision). |
| **4. Phân ca & Chấm công đa nguồn** | Lập lịch phân ca dự án → Thu thập sự kiện check-in qua 4 kênh (Máy quét HMAC, Kiosk QR xoay 30s, Khuôn mặt sinh trắc học, Web) → Tự động ghép ca → Giải trình lệch công → Khóa công tháng. <br>*Chứng từ: Bảng phân ca, Sự kiện điểm danh, Đơn giải trình chấm công.* | **UC18** (kèm **UC26** QR, **UC27** Face); **UC29** (Giải trình); **UC30** (Phân ca) | `/attendance` (Bảng chấm công) <br>`/shifts` (Ca làm việc) <br>`/check-in` (Kiosk điểm danh QR/Face) <br>`/admin/attendance` (Máy chấm công) | Toàn thể nhân viên, Trưởng dự án (Bridge), CV Chấm công (Hub), Quản trị viên (ADMIN). |
| **5. Quản lý Nghỉ phép** | Tra cứu số dư phép năm → Nộp đơn xin nghỉ trên ESS → Tự động kiểm tra quỹ phép khả dụng (Hard stop) → Quản lý dự án phê duyệt → Tự động trừ quỹ phép và cập nhật bảng công. <br>*Chứng từ: Đơn xin nghỉ phép điện tử, Giấy ra viện/chứng nhận y tế.* | **UC20** | `/leave` (Nghỉ phép) <br>`/ess` (Cổng nhân viên) | Nhân viên nộp đơn (Bridge), Quản lý dự án duyệt (Bridge), CV Nhân sự (Hub). |
| **6. Quản lý Làm thêm giờ (OT)** | Lập kế hoạch OT trước ca → Kiểm soát trần luật định ≤ 40h/tháng (Hard stop) → Quản lý phê duyệt → Điểm danh giờ OT thực tế → Đối soát giờ công và tính tiền làm thêm. <br>*Chứng từ: Đơn đăng ký làm thêm giờ, Bảng đối soát giờ OT.* | **UC19** | `/overtime` (Làm thêm giờ) <br>`/ess` (Cổng nhân viên) | Trưởng dự án (Bridge), Nhân viên tham gia (Bridge), CV Tiền lương (Hub), Giám đốc (Decision). |
| **7. Chu kỳ tính lương & Khóa bảng lương** | Khóa dữ liệu công ngày 25 → Chạy Payroll Engine tính lương Gross-Net → Trích nộp BHXH & Thuế TNCN lũy tiến → Khấu trừ nợ vay (≤ 30% Net) → Đối chiếu quỹ chi → Khóa bảng lương bất biến (LOCKED) → Gửi Payslip bảo mật. <br>*Chứng từ: Bảng tính lương tổng hợp, Phiếu lương cá nhân (Payslip).* | **UC21 → UC22 → UC23 → UC24**; **UC31** (Bảng lương tự động) | `/payroll-engine` (Bảng lương) <br>`/ess` (Phiếu lương cá nhân) <br>`/personnel-reports` (Báo cáo nhân sự) | CV Tiền lương (Hub), Kế toán trưởng (Hub), Giám đốc (Decision), Toàn thể nhân viên. |
| **8. Tạm ứng lương & Khoản vay phúc lợi** | Nộp đơn vay/tạm ứng trên ESS → Kiểm soát mức trả nợ hàng tháng EMI ≤ 30% lương Net (Hard stop) → Thẩm định hợp đồng → Phê duyệt giải ngân → Tự động trừ nợ vào kỳ lương hàng tháng. <br>*Chứng từ: Đơn đề nghị vay/tạm ứng, Khế ước nhận nợ, Lịch trả nợ.* | **UC32** | `/loans` (Tạm ứng & Vay) <br>`/ess` (Cổng nhân viên) | Nhân viên nộp đơn (Bridge), CV Nhân sự (Hub), Kế toán (Hub), Giám đốc (Decision). |
| **9. Đề xuất công tác & Quyết toán chi phí** | Tạo đề xuất công tác & dự toán → Duyệt lệnh công tác → Tạm ứng công tác phí → Đi công tác thu thập e-invoice → Nộp bảng kê chi phí → Hậu kiểm định mức quy chế → Quyết toán hoàn ứng. <br>*Chứng từ: Lệnh điều động công tác, Hóa đơn tài chính VAT, Bảng kê thanh toán.* | **UC33** | `/expense-claims` (Công tác phí) <br>`/ess` (Cổng nhân viên) | Kỹ sư đi công tác (Bridge), Trưởng dự án (Bridge), Kế toán thanh toán (Hub), Giám đốc. |
| **10. Quản lý Tài sản & Thiết bị làm việc** | Nhập kho & dán mã Asset Tag → Lập phiếu cấp phát laptop/màn hình → Nhân viên ký nhận điện tử trên ESS → Theo dõi hiện trạng bảo dưỡng → Thu hồi tài sản khi thôi việc (Hard stop). <br>*Chứng từ: Phiếu cấp phát tài sản, Biên bản bàn giao điện tử, Biên bản thu hồi.* | **UC34** | `/assets` (Tài sản) <br>`/employees/[id]` (Tab Tài sản hồ sơ) | NV Hành chính (Hub), NV IT Support (Bridge), Kỹ sư sử dụng (Bridge). |
| **11. Đánh giá Hiệu suất 360 độ** | Giao mục tiêu OKR/KPI đầu kỳ → Mở đợt đánh giá định kỳ 6 tháng → Nhân viên tự đánh giá → Đồng nghiệp đánh giá chéo (Peer-review) → Quản lý trực tiếp chấm điểm → Hiệu chuẩn xếp loại. <br>*Chứng từ: Bản đăng ký mục tiêu OKR, Phiếu đánh giá hiệu suất 360, Bảng xếp loại.* | **UC36** | `/performance-360` (Đánh giá KPI) <br>`/ess` (Cổng nhân viên) | Toàn thể nhân viên, Đồng nghiệp (Bridge), Quản lý dự án (Bridge), Ban Giám đốc (Decision). |
| **12. Tăng lương định kỳ & Nâng bậc NĐ 204** | Hệ thống quét tự động cán bộ đủ thâm niên giữ bậc 24/36 tháng → Kiểm tra tiêu chuẩn kỷ luật và hiệu suất (Hard check) → Lập danh sách dự toán quỹ lương → Phê duyệt → Sinh Quyết định nâng bậc. <br>*Chứng từ: Danh sách đề xuất nâng ngạch bậc, Quyết định nâng bậc lương.* | **UC15, UC40** | `/salary-ranks` (Ngạch bậc lương) <br>`/personnel` (Biến động nhân sự) <br>`/personnel-reports` (Báo cáo nhân sự) | Hệ thống tự động quét, CV Nhân sự (Hub), Kế toán (Hub), Giám đốc (Decision). |
| **13. Điều chuyển & Bổ nhiệm vị trí** | Tạo đề xuất biến động nhân sự → Quản lý cũ và mới phê chuẩn kế hoạch bàn giao → Giám đốc ký Quyết định điều chuyển → Hệ thống tự động cập nhật OrgUnit, cây phê duyệt và phân ca. <br>*Chứng từ: Phiếu đề xuất biến động nhân sự, Quyết định điều chuyển/bổ nhiệm.* | **UC14** | `/personnel` (Biến động nhân sự) <br>`/org-chart` (Sơ đồ tổ chức) <br>`/employees/[id]` (Hồ sơ nhân viên) | Trưởng dự án cũ/mới (Bridge), CV Nhân sự (Hub), Giám đốc (Decision). |
| **14. Đào tạo nội bộ & Giải quyết Khiếu nại** | Lập chương trình đào tạo công nghệ → Tổ chức học và thi đánh giá → Cập nhật chứng chỉ hồ sơ; Tiếp nhận đơn khiếu nại (hỗ trợ ẩn danh) → Điều tra đối thoại 15 ngày → Ban hành thông báo kết luận. <br>*Chứng từ: Kế hoạch đào tạo, Chứng chỉ hoàn thành, Đơn khiếu nại, Biên bản đối thoại.* | **UC37** | `/training-grievance` (Đào tạo & Khiếu nại) <br>`/documents` (Kho tài liệu) | Toàn thể nhân viên, Giảng viên (Bridge), CV Nhân sự (Hub), Giám đốc & Đại diện NLĐ. |
| **15. Khen thưởng & Kỷ luật lao động** | Lập biên bản sự việc vi phạm/thành tích → Thẩm định hồ sơ và thời hiệu → Họp hội đồng kỷ luật có đại diện công đoàn → Ký quyết định → Đồng bộ nạp tiền thưởng/phạt vào kỳ lương và hồ sơ lý lịch. <br>*Chứng từ: Biên bản vi phạm nội quy, Giấy mời họp hội đồng, Quyết định kỷ luật/khen thưởng.* | **UC16** | `/personnel` (Biến động nhân sự) <br>`/documents` (Kho tài liệu) <br>`/employees/[id]` (Quá trình khen thưởng/kỷ luật) | Quản lý trực tiếp (Bridge), Đại diện Công đoàn (Bridge), CV Nhân sự (Hub), Giám đốc (Decision). |
| **16. Hồ sơ Cán bộ toàn diện & Mẫu 2C-BNV** | Thu thập và số hóa 111 trường dữ liệu nhân thân cán bộ → Theo dõi cập nhật 8 bảng diễn biến quá trình (công tác, lương, đào tạo, gia đình) → Kiểm tra tính hợp lệ → Kết xuất sơ yếu lý lịch Mẫu 2C in A4. <br>*Chứng từ: Sơ yếu lý lịch cán bộ Mẫu 2C-BNV/2008, Báo cáo biến động lao động.* | **UC38 → UC39 → UC40 → UC41** | `/personnel-reports` (Báo cáo nhân sự) <br>`/documents` (Kho tài liệu) | Cán bộ/Kỹ sư tự kê khai, CV Hồ sơ cán bộ (Hub), Giám đốc (Decision). |
| **17. Thôi việc & Bàn giao đa bộ phận (Offboarding)** | Nộp đơn xin thôi việc trên ESS → Giám đốc duyệt ngày làm việc cuối → Hệ thống sinh Checklist 5 bước độc lập (Dự án bàn giao code, IT thu hồi tài khoản & xóa vector khuôn mặt, Hành chính thu máy, Kế toán chốt nợ, HR chốt bảo hiểm) → Chặn ban hành quyết định nếu checklist chưa đủ 100% (Hard stop) → Giám đốc ký Quyết định chấm dứt HĐLĐ → Chuyển trạng thái Terminated, khóa tài khoản vĩnh viễn. <br>*Chứng từ: Đơn xin thôi việc, Handover Checklist 5 bên, Quyết định chấm dứt HĐLĐ, Tờ rời chốt sổ BHXH.* | **UC17, UC44** | `/personnel` (Biến động nhân sự) <br>`/employees/[id]` (Hồ sơ nhân viên) <br>`/admin/users` (Tài khoản) | Nhân viên thôi việc (Bridge), Trưởng dự án (Bridge), NV IT (Bridge), NV Hành chính (Hub), Kế toán (Hub), Giám đốc. |
...
| **Nền tảng vận hành & Tri thức số** | Xác thực JWT kép, kiểm soát truy cập phân quyền hai chiều RBAC, quản trị cây danh mục dùng chung (Master Catalogs), thiết lập tham số hệ thống, quản lý nhật ký kiểm toán Append-only, đóng góp và xuất bản bài viết tri thức nội bộ có phiên bản bất biến. <br>*Chứng từ: Nhật ký hệ thống AuditLog, Bản thảo bài viết tri thức.* | **UC01, UC02, UC03, UC25, UC28, UC42, UC43, UC45, UC46, UC47** | `/dashboard` (Tổng quan) <br>`/documents` (Kho tài liệu) <br>`/admin/users` (Tài khoản) <br>`/admin/org-units` (Đơn vị phòng ban) <br>`/admin/catalogs` (Danh mục gốc) <br>`/admin/attendance` (Máy chấm công) <br>`/admin/settings` (Cấu hình) <br>`/admin/audit` (Nhật ký) | Toàn thể nhân viên, Chuyên viên quản trị nội dung (KM_MANAGER), Quản trị viên hệ thống (ADMIN). |
...
Thiết kế giao diện người dùng đóng vai trò là cầu nối tương tác trực tiếp giữa người sử dụng và hệ thống. Toàn bộ giao diện được chuẩn hóa đồng bộ theo hệ thống Design Tokens trung tính của Shadcn UI (Zinc/Slate theme), loại bỏ triệt để các màu sắc bão hòa tùy tiện, sử dụng đồng nhất bảng màu chuẩn ngữ nghĩa (`bg-primary`, `bg-card`, `bg-muted`, `border-border`, `text-foreground`, `text-muted-foreground`), kết hợp typography Inter sắc nét, tối giản hóa thao tác và tối ưu hóa luồng công việc cho từng vai. Thanh điều hướng chính (Sidebar) được tinh gọn và tổ chức khoa học thành **7 phân hệ nghiệp vụ chuẩn hóa (Business Domains)**, loại bỏ hoàn toàn tình trạng gộp tên cồng kềnh, phân mảnh hoặc các đường dẫn chuyển hướng (redirect) ảo. Hệ thống bao gồm tổng cộng **28 trang màn hình tác nghiệp trực tiếp trong ứng dụng (`frontend/src/app/(app)/*`)** theo cấu trúc App Router của Next.js 14, cùng **2 giao diện chuyên biệt độc lập** (`/check-in` Kiosk và `/login` Xác thực) và trang chủ `/` (tổng cộng 31 route hoạt động thực tế với 100% mã phản hồi HTTP 200 OK); mọi màn hình đều tích hợp thanh tìm kiếm thông minh **Command Palette (Ctrl+K)** điều hướng tức thì; trên thiết bị di động hỗ trợ thanh điều hướng đáy (bottom-nav) tiện dụng.

Cấu trúc 7 phân hệ nghiệp vụ chuẩn hóa và các giao diện chuyên biệt bao gồm:

1. **Phân hệ Không gian làm việc (Workspace Domain):**
...
2. **Phân hệ Nhân sự & Tổ chức (Personnel & Organization Domain):**
...
3. **Phân hệ Chấm công & Ca làm việc (Time & Attendance Domain):**
...
4. **Phân hệ Đãi ngộ & Tài chính (Compensation & Benefits Domain):**
...
5. **Phân hệ Phát triển & Tuyển dụng (Development & Recruitment Domain):**
...
6. **Phân hệ Báo cáo & Tài liệu số (Reports & Documents Domain):**
...
7. **Phân hệ Quản trị hệ thống (System Administration Domain):**
   - Gồm 6 màn hình quản trị chuyên sâu dành cho vai trò ADMIN:
     - `/admin/users`: Quản trị tài khoản và phân quyền người dùng (Role-based Access Control).
     - `/admin/org-units`: Quản trị cơ cấu phòng ban và cây tổ chức doanh nghiệp.
     - `/admin/catalogs`: Quản trị danh mục dùng chung (Master Catalogs) với 6 nhóm danh mục chuẩn hóa.
     - `/admin/attendance`: Quản trị thiết bị máy chấm công và xử lý ngoại lệ lệch công.
     - `/admin/settings`: Cấu hình tham số vận hành hệ thống.
     - `/admin/audit`: Nhật ký kiểm toán hệ thống Append-only bất biến.

8. **Giao diện Chuyên biệt & Điểm danh đa phương thức:**
   - `/check-in`: Giao diện Kiosk toàn màn hình đa năng hỗ trợ điểm danh bằng mã QR xoay vòng tự động mỗi 30 giây (kèm token mã hóa HMAC chống chụp ảnh giả mạo) và nhận diện khuôn mặt sinh trắc học tuân thủ Nghị định 13/2023/NĐ-CP.
   - `/login`: Giao diện xác thực bảo mật tập trung hỗ trợ JWT, kiểm tra trạng thái tài khoản và điều hướng tức thì theo vai trò.

**Hệ thống Design System và Quy chuẩn Trình bày (Visual Tokens & Print Standards):**
- **Quy chuẩn hiển thị và tương tác sạch (Clean Interaction Standards):** Toàn bộ các tương tác chuột trên sidebar, nút tác vụ, trường nhập liệu và bảng dữ liệu đều được loại bỏ triệt để viền đen nhấp nháy mặc định của trình duyệt (`outline-none`, `focus-visible:ring-1 focus-visible:ring-primary`), mang lại cảm giác mượt mà, đồng bộ và thẩm mỹ cao theo tiêu chuẩn ứng dụng doanh nghiệp cao cấp.
- **Bộ khung in ấn chuẩn quốc gia A4 (A4 Print Frame Standard):** Mọi trang quản trị và biểu mẫu hành chính (Quyết định nhân sự, Phiếu lương, Sơ yếu lý lịch Mẫu 2C-BNV/2008) được bao gói chuẩn hóa qua component `PrintFrame` và khối chữ ký trách nhiệm `PrintSignatureBlock`. Khi người dùng kích hoạt lệnh in (`window.print()`), hệ thống CSS chuyên dụng `@media print` tự động triệt tiêu các thành phần điều hướng (Sidebar, Topbar, Floating action buttons), định hình trang in khổ A4 (khổ chuẩn 210mm × 297mm, lề 20mm/15mm), chia cột cân đối và ngăn chặn hiện tượng vỡ trang bảng biểu (`break-inside: avoid`).

**Kiến trúc Phân tầng Hiển thị và Bảo vệ Thanh tiêu đề (6-Tier Z-Index Stacking Architecture & Topbar Safety):**
Trong quá trình vận hành các biểu mẫu nghiệp vụ phức tạp (như bộ chọn tháng chấm công, popover phân ca, bộ lọc hồ sơ ứng viên, modal duyệt phép), hiện tượng menu popover nổi đè lên thanh tiêu đề đỉnh (Topbar) hoặc xuyên qua các lớp hộp thoại là một lỗi giao diện nghiêm trọng. Để giải quyết dứt điểm vấn đề này, kiến trúc giao diện thiết lập mô hình xếp tầng hiển thị 6 cấp độ nghiêm ngặt kết hợp cơ chế kiểm soát hình học thông minh:
...
**Tầng giao diện người dùng:** Ứng dụng web **Next.js 14 standalone** - vừa phục vụ UI cho mọi vai vừa làm reverse proxy `/api/* → api:3001` (không cần nginx riêng); gồm **31 trang màn hình ứng dụng thực tế** phân theo 7 phân hệ nghiệp vụ chuẩn hóa (28 màn hình nghiệp vụ trực tiếp trong ứng dụng `src/app/(app)/*`), cùng giao diện điểm danh kiosk `/check-in` và đăng nhập `/login`; thiết kế đáp ứng đa thiết bị (mobile-responsive) với bottom-nav.

**Tầng xử lý nghiệp vụ:** **NestJS API** chứa toàn bộ quy tắc và logic cốt lõi: validation DTO toàn cục, JwtAuthGuard → RolesGuard, **39 module nghiệp vụ chuyên sâu** (bao gồm CatalogsModule quản trị danh mục dùng chung toàn hệ thống) hoạt động trên hai bộ phận dùng chung - **Bộ phận phê duyệt (ApprovalEngine → PersonnelActionsModule)** và **Bộ phận tính lương (PayrollEngine → PayrollModule + HrmsPayrollModule)** - cùng dịch vụ thông báo (NotificationsService), kiểm toán (AuditService) và danh mục dùng chung (CatalogsModule). Các khối giao tiếp bằng cơ chế truyền thông điệp (event): khi khối Biến động nhân sự duyệt đơn khen thưởng, số thưởng chuyển xuống khối Lương nạp vào kỳ kế tiếp; khi khối Chấm công ghi sự kiện, event handler tự tổng hợp bảng công ngày.
...
Chương 2 trình bày chi tiết quá trình thiết kế hệ thống thông tin quản trị nhân lực HRMIS cho Saigon Technology trên nền khảo sát mã nguồn đã cài đặt (39 module backend, 31 trang màn hình ứng dụng frontend - trong đó có 28 màn hình nghiệp vụ trực tiếp phân thành 7 phân hệ chuẩn hóa, 87 model dữ liệu).

Tiếp đó, chương xác định 11 tác nhân nghiệp vụ ánh xạ vào ba vai phân quyền; phân tầng yêu cầu từ quy trình nghiệp vụ xuống use case hệ thống với bảng nối thẳng tới màn hình thật; đặc tả 47 use case chia 12 nhóm kèm đặc tả chi tiết các use case trọng yếu và bảng tham số pháp lý; thiết lập mô hình phân cấp quản trị dữ liệu nhân sự 3 mức độ (Tier 1: Tự phục vụ, Tier 2: Đề xuất có minh chứng pháp lý, Tier 3: Khóa chỉ xem do tổ chức quản trị). Cấu trúc tĩnh gồm ba loại lớp Biên - Điều khiển - Thực thể và hai bộ phận dùng chung; hành vi động mô hình hóa bằng biểu đồ Use case, Trình tự, Hoạt động, Trạng thái và Cộng tác. Thiết kế lưu trữ gồm 10 miền - 87 model với ba ràng buộc bất biến; giao diện mô tả theo 31 trang màn hình ứng dụng thực tế phân thành 7 phân hệ nghiệp vụ chuẩn hóa; kiến trúc triển khai là ba service Docker (web - api - db).
...
- **Về chất lượng:** build + lint + type-check **0 lỗi** cả backend và frontend; kịch bản kiểm thử end-to-end trên Docker chạy thật (`backend/scripts/verify-hr.mjs` và `backend/scripts/verify-personnel.mjs`) đạt **39 PASS / 0 FAIL**, phủ các luồng: đăng nhập/đăng xuất thu hồi token, phân cấp dữ liệu cá nhân và duyệt đề xuất thay đổi Mức 2, chặn đơn phép vượt quỹ, duyệt phép trừ quỹ ngay, chu kỳ lương khóa bất biến, thôi việc tự sinh checklist bàn giao, xuất bản tri thức có phiên bản; kiểm định tự động toàn bộ 28 route giao diện nội bộ đạt HTTP 200 OK phản hồi dưới 100ms mà không sử dụng redirect trung gian; kiểm tra kiểu tĩnh TypeScript (`tsc --noEmit`) đạt **0 lỗi** trên toàn dự án;
